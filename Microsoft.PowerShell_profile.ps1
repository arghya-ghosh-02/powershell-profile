...
############                       https://github.com/arghya-ghosh-02/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/arghya-ghosh-02/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
function gpr($branch) {
    ...
    & scp -P 29418 argghosh@gerrit-git.amd.com:hooks/commit-msg "$gitdir/hooks/"
